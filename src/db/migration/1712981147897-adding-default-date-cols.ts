...
export class AddingDefaultDateCols1712981147897 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "pet" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`ALTER TABLE "organization" DROP CONSTRAINT "UQ_480aaa8101e24b3d4e4d874e441"`);
        await queryRunner.query(`ALTER TABLE "organization" DROP COLUMN "cnpj"`);
        await queryRunner.query(`ALTER TABLE "organization" ADD "cnpj" character varying(14) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "organization" ADD CONSTRAINT "UQ_480aaa8101e24b3d4e4d874e441" UNIQUE ("cnpj")`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "date" SET DEFAULT '2024-04-13T04:05:48.771Z'`);
    }
