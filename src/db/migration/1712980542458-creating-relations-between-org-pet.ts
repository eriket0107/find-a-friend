...
export class CreatingRelationsBetweenOrgPet1712980542458 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "date" SET DEFAULT '2024-04-13T03:55:43.306Z'`);
