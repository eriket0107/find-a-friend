...
export class AddAuthOrg1713226628004 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "organization" ADD "email" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "organization" ADD CONSTRAINT "UQ_5d06de67ef6ab02cbd938988bb1" UNIQUE ("email")`);
        await queryRunner.query(`ALTER TABLE "organization" ADD "password" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "organization" ADD CONSTRAINT "UQ_d8fd9e1d79363b3659e1b7db5f7" UNIQUE ("password")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "organization" DROP CONSTRAINT "UQ_d8fd9e1d79363b3659e1b7db5f7"`);
        ...
        await queryRunner.query(`ALTER TABLE "organization" ADD "phone" character varying NOT NULL`);
    }
