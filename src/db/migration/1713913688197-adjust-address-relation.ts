...
export class AdjustAddressRelation1713913688197 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "organization" DROP CONSTRAINT "REL_63c0d3f228775d613e037b94e2"`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "organization" ADD CONSTRAINT "REL_63c0d3f228775d613e037b94e2" UNIQUE ("addressId")`,
    )
    await queryRunner.query(
